        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    <label for="title"><?php echo JText::_( 'Tên Công Ty' ); ?></label>
                    <input class="form-control" type="text" name="name" id="title"maxlength="255" value="<?php echo $row->name; ?>" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label><?php echo JText::_( 'Nhân Viên' ); ?></label>
                    <?php echo JHTMLJobMg::SelectMultiUsers(NULL,"users",$row->id,'company'); ?>
                </div>
            </div>
