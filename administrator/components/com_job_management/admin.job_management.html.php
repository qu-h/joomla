...
class JobManagementView
{
	...
	function showJobs( &$rows, &$lists, $page, $redirect )
	{
	...
	*/
	...
	function form( &$row, $section, &$lists, &$sectioncategories, $option, &$form )
	{
		...
		<tr>
			<td valign="top">
				<?php JobManagementView::_displayArticleDetails( $row, $lists ); ?>
